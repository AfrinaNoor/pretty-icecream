...
const Hero = () => {
  const slides = [
    {
      ...
      main: cherryIcecream,
      fruits: [
        { src: cherry1, style: { top: "8%", left: "15%", width: "260px", rotate: "-40deg" } },
        { src: cherry2, style: { top: "30%", right: "15%", width: "260px", rotate: "15deg" } },
        { src: cherry3, style: { bottom: "10%", left: "20%", width: "260px", rotate: "-20deg" } },
        { src: cherry4, style: { bottom: "-5%", right: "25%", width: "260px", rotate: "10deg" } },
      ],
    },
    {
      flavor: "Apple",
      ...
      main: appleIcecream,
      fruits: [
        { src: apple1, style: { top: "5%", left: "10%", width: "260px", rotate: "-5deg" } },
        { src: apple2, style: { top: "20%", right: "12%", width: "260px", rotate: "10deg" } },
        { src: apple3, style: { bottom: "2%", left: "22%", width: "260px", rotate: "-12deg" } },
        { src: apple4, style: { bottom: "10%", right: "25%", width: "260px", rotate: "8deg" } },
      ],
    },
    {
      flavor: "Chocolate",
      ...
      fruits: [
        { src: choco1, style: { top: "10%", left: "19%", width: "260px", rotate: "-10deg" } },
        { src: choco2, style: { top: "25%", right: "15%", width: "260px", rotate: "5deg" } },
        { src: choco3, style: { bottom: "10%", left: "25%", width: "260px", rotate: "-15deg" } },
        { src: choco4, style: { bottom: "12%", right: "20%", width: "260px", rotate: "10deg" } },
      ],
    },
    {
      flavor: "Peach",
      ...
      main: peachIcecream,
      fruits: [
        { src: peach1, style: { top: "8%", left: "8%", width: "360px", rotate: "-8deg" } },
        { src: peach2, style: { top: "28%", right: "9%", width: "360px", rotate: "10deg" } },
        { src: peach3, style: { bottom: "1%", left: "20%", width: "360px", rotate: "-12deg" } },
        { src: peach4, style: { bottom: "-5%", right: "22%", width: "360px", rotate: "8deg" } },
      ],
    },
    {
      flavor: "Blueberry",
      ...
      fruits: [
        { src: blueberry1, style: { top: "10%", left: "12%", width: "260px", rotate: "-5deg" } },
        { src: blueberry2, style: { top: "25%", right: "15%", width: "260px", rotate: "80deg" } },
        { src: blueberry3, style: { bottom: "8%", left: "25%", width: "260px", rotate: "-10deg" } },
        { src: blueberry4, style: { bottom: "10%", right: "20%", width: "260px", rotate: "6deg" } },
      ],
    },
    {
      flavor: "Strawberry",
      ...
      fruits: [
        { src: strawberry1, style: { top: "8%", left: "15%", width: "260px", rotate: "-10deg" } },
        { src: strawberry2, style: { top: "28%", right: "18%", width: "260px", rotate: "12deg" } },
        { src: strawberry3, style: { bottom: "14%", left: "22%", width: "200px", rotate: "-8deg" } },
        { src: strawberry4, style: { bottom: "12%", right: "15%", width: "260px", rotate: "10deg" } },
      ],
    },
    {
      flavor: "Pistachio",
      ...
      fruits: [
        { src: pistachio1, style: { top: "10%", left: "12%", width: "260px", rotate: "-10deg" } },
        { src: pistachio2, style: { top: "25%", right: "15%", width: "260px", rotate: "10deg" } },
        { src: pistachio3, style: { bottom: "12%", left: "20%", width: "260px", rotate: "-8deg" } },
        { src: pistachio4, style: { bottom: "10%", right: "18%", width: "260px", rotate: "6deg" } },
      ],
    },
    {
      flavor: "Hazelnut",
      ...
      fruits: [
        { src: hazelnut1, style: { top: "10%", left: "15%", width: "260px", rotate: "-10deg" } },
        { src: hazelnut2, style: { top: "25%", right: "15%", width: "260px", rotate: "10deg" } },
        { src: hazelnut3, style: { bottom: "12%", left: "18%", width: "260px", rotate: "-8deg" } },
        { src: hazelnut4, style: { bottom: "10%", right: "18%", width: "260px", rotate: "6deg" } },
      ],
    },
    {
      flavor: "Lychee Rose",
      ...
      fruits: [
        { src: lychee1, style: { top: "10%", left: "12%", width: "260px", rotate: "-10deg" } },
        { src: lychee2, style: { top: "25%", right: "15%", width: "260px", rotate: "10deg" } },
        { src: rose1, style: { bottom: "12%", left: "18%", width: "260px", rotate: "-8deg" } },
        { src: rose2, style: { bottom: "10%", right: "18%", width: "260px", rotate: "6deg" } },
      ],
    },
  ];
  ...
  const imageVariants = {
    ...
    visible: { opacity: 1, rotate: 100, scale: 1, transition: { duration: 0.8, ease: "easeOut" } },
    exit: { opacity: 0, rotate: 0, transition: { duration: 0.4, ease: "easeIn" } },
  };

  return (
    <div className="hero" style={{ background: `radial-gradient(circle, ${c1} 0%, ${c1} 20%, ${c2} 20%, ${c2} 40%, ${c1} 40%, ${c1} 60%, ${c2} 60%, ${c2} 85%, ${c1} 85%, ${c1} 100%)` }}>
      <AnimatePresence mode="wait" custom={index}>
        <motion.div
          key={current.flavor}
          className="text-curve"
          variants={{
            enter: (direction) => ({ y: direction === "next" ? 50 : -50, opacity: 0 }),
            center: { y: 0, opacity: 1, transition: { duration: 0.6, ease: "easeOut" } },
            exit: (direction) => ({ y: direction === "next" ? -50 : 50, opacity: 0, transition: { duration: 0.6, ease: "easeIn" } }),
          }}
          initial="enter"
          animate="center"
          exit="exit"
      ...
      <AnimatePresence mode="wait">
        <motion.img key={current.main} src={current.main} alt={current.flavor} className="icecream" variants={imageVariants} initial="hidden" animate="visible" exit="exit" />
        {current.fruits.map((fruit) => (
          <motion.img key={fruit.src} src={fruit.src} alt="" className="fruit" style={fruit.style} variants={imageVariants} initial="hidden" animate="visible" exit="exit" />
        ))}
      </AnimatePresence>
